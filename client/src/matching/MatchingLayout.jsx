...
/**
 * Shared shell for matching pages — reuses the landing-page atmosphere
 * so the mentee flow feels like a continuation of the product, not a separate app.
 */
function MatchingLayout({
  ...
  const { dir, language, t } = useMatchingLanguage();
